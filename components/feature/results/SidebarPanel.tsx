...
export function SidebarPanel({ title, subtitle, items, onDownloadPdf }: SidebarPanelProps) {
  return (
    <aside className="sidebar-panel space-y-4">
      <div className="rounded-[24px] border border-slate-200 bg-surface p-5 shadow-card">
      ...
      <div className="sidebar-panel-actions rounded-[24px] border border-slate-200 bg-surface p-5 shadow-card">
