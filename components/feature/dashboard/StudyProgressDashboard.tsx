    ...
    <section className="space-y-8">
      <ChartCard
        ...
        subtitle={
          ...
          "Vidya will highlight your weakest topics, concepts, and question patterns here."
        }
      >
      ...
      <div className="grid gap-5 xl:grid-cols-[1.2fr_0.8fr]">
        <ChartCard
          ...
          subtitle="Each bar represents your number of Vidya sessions for that day."
        >
        ...
        >
          <div className="mt-6 space-y-3">
            {isLoadingPerformanceInsights ? (
              ...
              <EmptyChartMessage message="No weak areas yet. Complete a few practice sessions and Vidya will flag the patterns." />
            )}
          </div>
        </ChartCard>
