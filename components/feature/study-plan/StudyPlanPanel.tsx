...
export function StudyPlanPanel({
  ...
  function exportPlan() {
    ...
    if (!printWindow) {
      window.alert("Please allow pop-ups so Vidya can open the printable study plan.");
      return;
    }
...
function getCopy(language: LanguageMode) {
  return language === "hinglish"
    ? {
        ...
        subtitle: "Exam date, subjects, weak areas, aur daily hours ke basis par Vidya aapke liye day-by-day plan banata hai.",
        formTitle: "Plan Setup",
        formSubtitle: "Basic details do, baaki scheduling Vidya handle karega.",
    ...
    : {
        eyebrow: "Study Planner",
        title: "Personalized Study Plan",
        subtitle: "Vidya turns your exam date, syllabus, weak areas, and available hours into a day-by-day preparation roadmap.",
        formTitle: "Plan Setup",
        formSubtitle: "Enter your exam details once and let Vidya balance concepts, revision, practice, and mock tests.",
        resetTemplate: "Reset template",
        examType: "Exam Type",
        examDate: "Exam Date",
        dailyHours: "Daily Study Hours",
        ...
        emptyDescription: "Fill in the setup form and Vidya will generate a structured preparation plan for you.",
      };
}
