                ...
                <div className="mx-auto max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-500">
                  <header className="mb-10 text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-slate-500">
                      Sanctum is ready to generate your specialized mock test. Select your difficulty and mode below to begin the 30-question simulation.
                    </p>
                  </header>
...
function defaultSubtitle() {
  return "An editorial deep-dive generated by Sanctum based on your study material.";
}
    ...
    <div className="space-y-8">
      <header className="space-y-3">
        ...
        <p className="max-w-3xl text-[16px] leading-7 text-slate-500">
          A refined timeline of your intellectual exploration. Revisit past Sanctum sessions, saved topics, and recent study work.
        </p>
      </header>
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <StatsCard
          ...
          subtitle="Based on your latest Sanctum activity"
